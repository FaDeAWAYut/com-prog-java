	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
		...
		if ((s1 != null && f1 != null && s2 != null && f2 != null)) {
			...
			if (s1 instanceof DListIterator && s2 instanceof DListIterator && f1 instanceof DListIterator && f2 instanceof DListIterator) {
				...
				DListIterator StartItr1 = (DListIterator) s1;
				DListIterator FinItr1 = (DListIterator) f1;
				DListIterator StartItr2 = (DListIterator) s2;
				DListIterator FinItr2 = (DListIterator) f2;
				
				DListNode StartNode1 = StartItr1.currentNode;
				DListNode FinNode1 = FinItr1.currentNode;
				DListNode StartNode2 = StartItr2.currentNode;
				DListNode FinNode2 = FinItr2.currentNode;
				
				DListNode Nextf1 = FinNode1.nextNode; // d
				DListNode BFf1 = StartNode1.previousNode; // a
				
				DListNode Nextf2 = FinNode2.nextNode; // g
				DListNode BFf2 = StartNode2.previousNode; // z
				
				if (FinNode1.nextNode == StartNode2) {
					FinNode2.nextNode = StartNode1;
					StartNode1.previousNode = FinNode2;
					BFf1.nextNode = StartNode2;
					StartNode2.previousNode = BFf1;
					FinNode1.nextNode = Nextf2;
					Nextf2.previousNode = FinNode1;
				}
				
				else {
					Nextf2.previousNode = FinNode1;
					FinNode1.nextNode = Nextf2;
					FinNode2.nextNode = Nextf1;
					Nextf1.previousNode = FinNode2;
					BFf1.nextNode = StartNode2;
					StartNode2.previousNode = BFf1;
					BFf2.nextNode = StartNode1;
					StartNode1.previousNode = BFf2;
				}
